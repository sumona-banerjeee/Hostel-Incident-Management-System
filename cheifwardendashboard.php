...
<head>
    ...
    <link rel="stylesheet" href="cheifwardendashboard.css">
</head>
<body>
    <div class="container">
        <h4>Welcome, <span id="wardenName">Chief Warden</span></h4>
    ...
    <table class="highlight responsive-table">
        ...
        <tbody id="incidentTable">
            <?php include 'fetch_cheifwardendashboard_incident.php'; ?>
        </tbody>
    </table>
</div>
